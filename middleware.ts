 ...
 * - Foundation for future authentication checks
 * - Foundation for future wallet verification
 * 
 ...
 * 
 * This matcher excludes static files and API routes from middleware execution
 * for better performance. Adjust as needed for your use case.
 */
export const config = {
  matcher: [
    /*
